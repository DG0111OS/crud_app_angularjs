...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="{{asset('admin_/images/favicon.png')}}" />
</head>
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="auth-form-transparent text-left p-3">
                        <div class="brand-logo">
                            <img src="{{asset('admin_/images/logo.svg')}}" alt="logo">
                        </div>
                        <h4>Welcome back!</h4>
                      ...
                      <span class="input-group-text bg-transparent border-right-0">
                        <i class="mdi mdi-lock-outline text-primary"></i>
                            ...
                            <div class="my-3">
                                <a class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" href="{{asset('admin_/index.html')}}">LOGIN</a>
                            </div>
